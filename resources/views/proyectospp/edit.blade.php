                    ...
                    <form action="{{ route('proyectospp.update',$proyecto->id) }}" class="row g-3 " method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select border" id="comuna" name="comuna">
                                <option selected="" disabled=""_msthash="680472"
                                    _msttexthash="101647">Elegir...</option>
                                @foreach ($comunas as $comuna)
                                    <option _msthash="680654" _msttexthash="14352"
                                        value="{{$comuna->numero}}" @if ($comuna->numero == $proyecto->comuna) selected @endif>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select border" id="lineaTematica" name="lineaTematica">
                                ...
                                @foreach ($tematicas as $tematica)
                                    <option _msthash="680654" _msttexthash="14352" @if ($tematica->EJE_NOMBRE == $proyecto->lineaTematica) selected @endif>
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select border" id="dependencia" name="dependencia">
                                ...
                                @foreach ($dependencias as $dependencia)
                                    <option _msthash="680654" _msttexthash="14352" @if ($dependencia->nombre == $proyecto->dependencia) selected @endif>
                        ...
                        <div class="col-md-4">
                            <label for="valorTotal" class="form-label" _msthash="3666832" _msttexthash="76193">Valor
                                total</label>
                            <input type="number" class="form-control" id="valorTotal" name="valorTotal" value="{{ old('valorTotal', $proyecto->valorTotal) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="posicion" name="posicion" value="{{ old('posicion', $proyecto->posicion) }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" placeholder="Área de texto de ejemplo requerida"
                                _mstplaceholder="853047" >{{ old('descripcion', $proyecto->descripcion) }}
                            </textarea>
